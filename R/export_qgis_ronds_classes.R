...
function(map,cheminDossier,nomFichier,titre1="",titre2="",source="")
  {
    ...
    l <- c()
    if(any(list_fonds[[2]] %in% "fond_ronds_classes_carte")) l <- c(l,"fond_ronds_classes_carte")
    if(any(list_fonds[[2]] %in% "fond_ronds_classes_elargi_carte")) l <- c(l,"fond_ronds_classes_elargi_carte")
